...
@Module
class RestModule(private val application: GotApplication) {

    companion object {
        const val API_ENDPOINT = "https://project-8424324399725905479.firebaseio.com/"
    }
    ...
    @Provides
    @Singleton
    fun provideApiService(baseUrl: String, gson: Gson, okHttpClient: OkHttpClient): GotService =
        Retrofit.Builder()
            .baseUrl(baseUrl)
            ...
            .client(okHttpClient)
            .build()
            .create<GotService>(GotService::class.java)
}